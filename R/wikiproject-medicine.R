## Data analysis and model building for WikiProject Medicine
...
data_dir = 'datasets/wikiproject-medicine';
config_file = 'medicine-config.yaml';
...
## We have 92 Top-importance articles. Use 40 for a test set, 50 for training.
## Seek 450 samples in the training set with synthetic samples.
n_samples_test = 40;
n_samples_training = 50;
n_samples_SMOTE = n_samples_training *9;
...
n_samples_training = 90;
n_samples_SMOTE = n_samples_training *10;
proj_full[, is_training := 0];
proj_full[talk_page_id %in%
