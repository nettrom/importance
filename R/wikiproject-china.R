## Data analysis and model building for WikiProject China
...
data_dir = 'datasets/wikiproject-china';
config_file = 'china-config.yaml';
...
## We have 418 Top-importance articles. Use 100 for a test set, 300 for training.
## Seek 900 samples in the training set with synthetic samples.
n_samples_test = 100;
n_samples_training = 300;
n_samples_SMOTE = n_samples_training *3;
...
n_samples_training = 400;
n_samples_SMOTE = n_samples_training *4;
proj_full[, is_training := 0];
proj_full[talk_page_id %in%
